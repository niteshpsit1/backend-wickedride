	...
	render: function(){
		return (
			<div className="pwd-block">
				...
				<form>
					<div className="f1"><label>Old Password</label><input type="password" name="oldPassword" className="form-control" onChange={this._onChange}/>{this.state.oldPasswordError}</div>
					<div className="f2"><label>New Password</label><input type="password" name="password" className="form-control" onChange={this._onChange}/>{this.state.passwordError}</div>
					<div className="f3"><label>Confirm Password</label><input type="password" name="confirmPassword" className="form-control" onChange={this._onChange}/>{this.state.confirmPasswordError}</div>
